...
| **affix**(item, baseItem, channel, params)| affix items to the specified base items in x or y direction<br>item ([Mark](../../marks/mark/)): an example item<br>baseItem ([Mark](../../marks/mark/)): an example base item<br>channel (String): "x" or "y"<br>params (Object, optional): additional parameters:<ul><li>itemAnchor (String): [anchor](../../global/constants/#anchor) of item, defaults to "center"</li><li>baseAnchor (String): [anchor](../../global/constants/#anchor) of base item, defaults to "middle"</li><li>offset (Number): distance between item anchor and base item anchor, defaults to 0</li></ul> | void |
{.table-striped}
