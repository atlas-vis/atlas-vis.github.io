...
scn.axis("x", "Value", {orientation: "bottom", pathY: 300});
scn.axis("y", "Name", {orientation: "left", pathVisible: false, tickVisible: false, pathX: 190});
scn.axis("y", "Group", {orientation: "left", pathVisible: false, tickVisible: false, pathX: 160});
