...
scn.axis("x", "Year", {orientation: "bottom", y: 420, labelFormat: "%Y", strokeColor: "#ccc", textColor: "#ccc"});
scn.axis("y", "Rank", {orientation: "left", x: 80, strokeColor: "#ccc", textColor: "#ccc"});
